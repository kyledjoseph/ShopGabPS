...
$(".social-login a").click(function() {
    mixpanel.track("Facebook Login (Sign up modal)");
});

$(".tour-quest-btn").click(function() {
    mixpanel.track("New Quest (Button)");
});

$(".new-quest-dotted").click(function() {
    mixpanel.track("New Quest (Image)");
});
