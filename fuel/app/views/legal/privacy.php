	...
	<ul>
		<li> Deliver the services and products that You have requested;</li>
...
Following registration, You can review and change the information You submitted during registration. For example, if You change Your name or email address we will retain a record of Your old name and email address.
</p><p>
...
Through regular use of ShopGab.com, as a member You might have access to another member’s contact or personally identifiable information. By accepting this Privacy Policy, You agree that You may not disclose another member’s personally identifiable information to any third party in any situation unless: 1) The terms of this Privacy Policy permit disclosure; 2) You have obtained permission from the other member; 3) You have obtained the permission of ShopGab.com; 4) Law enforcement agencies require disclosure to enforce a law, or otherwise require disclosure to investigate or prosecute unlawful activities such as frauds and scams.
</p><p>
Cookies
<ul>
...
Security
To safeguard the confidentiality of Your personally identifiable information, ShopGab.com utilizes sophisticated security techniques and procedures, including: daily security and vulnerability scans, software audits, firewalls, and data encryption (Secure Socket Layers). ShopGab.com treats data as an asset. We make every effort to protect that data against loss and unauthorized access. We employ many different security techniques to protect such data from unauthorized access by others.
</p><p>
Note about Children
...
The Privacy Policy is subject to change by Us at any time based on changes in the law or our need to accurately reflect our data collection and disclosure practices. Changes are effective upon posting on the ShopGab.com website.
</p>
</div>
</div>
<style type="text/css">
