	<div class="container">
		<div class="col-12">
			<h2>Terms of Use</h2>
<p>
SHOPGAB.COM TERMS AND CONDITIONS
</p><p>
ShopGab.com is a service provided by ItemNation, Inc. a Delaware corporation.
</p><p>
This User Agreement describes the terms on which ItemNation, Inc. (“ShopGab.com”, “we”, “us”), an Delaware corporation, offers you (“you” or “your”) access to our site (including all content and functionality available through ShopGab.com), and services provided by us. By visiting or using the services available on ShopGab.com (the “Site” or “ShopGab.com”) you are agreeing to the following terms without change (collectively, the “Agreement”). If you do not agree to any of the terms in this Agreement and the related policies referenced in this Agreement, please do not use this Site.
</p><p>
Eligibility
Only parties that can lawfully enter into and form legal contracts may use the Site and our services. If you use our services, you expressly represent to us that you are at least over the age of thirteen (13) and may lawfully enter into and form binding contracts, conditions, obligations, affirmations, representations and warranties. Before you may become a member of the Site, you must read and accept all of the terms and conditions in this Agreement. We reserve the right in our sole and absolute discretion to refuse, suspend, or terminate service to anyone.
</p><p>
Use Of The Site
...
<ul>
<li> register under a false name or use an invalid or unauthorized email or physical address;</li>
<li> use another's account without permission;</li>
<li> use the Site if you are not able to form legally binding contracts, are under the age of 18, or are temporarily or indefinitely suspended from using the Site;</li>
<li> use an invalid or unauthorized payment method;</li>
<li> impersonate another user ;</li>
<li> submit material that is copyrighted, protected by trade secret or otherwise subject to third party proprietary rights, including privacy and publicity rights, unless you are the owner of such rights or have permission from the rightful owner to post the material and grant us all of the license rights under this Agreement;</li>
<li> violate any laws, third party rights, or our rights;</li>
<li> post false, inaccurate, misleading, defamatory, or libelous content (including personal information);</li>
<li> take any action that may undermine the feedback or ratings systems (such as displaying, importing or exporting feedback information off ShopGab.com or using it for purposes unrelated to ShopGab.com);</li>
...
<li> distribute viruses or any other technologies that may harm us, or the interests or property of our users;</li>
<li> copy, modify, or distribute content from the Site and/or our copyrights and trademarks; or</li>
...
ShopGab.com reserves the right to remove any content posted by any member or cancel any membership or user ID for any reason.
</p><p>
...
(a) Services Provided. The Site is an online social shopping site where users can collect a universal list of desired products and request advice and product recommendations from their friends. (“Services”). You acknowledge that all location information that you upload to the Site will be visible by third parties. Please use discretion when sharing information.
</p><p>
ShopGab.com allows members to post comments and reviews of other members. You agree that you will not post any false, misleading, defamatory, or libelous statements in the review of any other member. ShopGab.com reserves the right to remove any comment or review for any reason.
...
Notwithstanding any other provision of this agreement, in no event will our liability to you for any action or claim related to the services provided under this agreement, whether based on contract, tort, negligence or any other theory of liability, exceed $100.00. Some states and jurisdictions do not allow for the exclusion or limitation of incidental or consequential damages, so this limitation and exclusion may not apply to you.
</p><p>
Indemnity
You agree to defend, hold harmless and indemnify ShopGab.com, its officers, directors, employees and agents, from and against any and all losses, costs, expenses, damages or other liabilities (including reasonable attorneys’ fees) incurred by us from and against any cost, liability, loss, damage, cause of action, claim, suit, proceeding, demand or action brought by a third party against us: (a) in connection with your use of the Site or Services, (b) your decision to submit personal information on the site and share personal information with others, (c) your breach of any provision of this Agreement, or (d) any negligent or intentional wrongdoing by any member. This defense and indemnification will survive this Agreement and your use of the Site.
</p><p>
...
(b) Reservation of Rights; Limited Licenses. We and our licensors retain all of its right, title and interest in and to all patent rights, inventions, copyrights, know-how and trade secrets relating to the Site. The ShopGab.com logo and name are trademarks of ShopGab.com, and may be registered in certain jurisdictions. All other product names, company names, marks, logos and symbols on ShopGab.com may be the trademarks of their respective owners. Except as expressly stated above, nothing in this Agreement confers any license under any of our or any third party’s intellectual property rights, whether by estoppel, implication or otherwise.
</p><p>
Notices
...
This Agreement is governed in all respects by the laws of the State of Delaware, without giving effect to any principle that may provide for the application of the law of another jurisdiction. You agree that any claim or dispute you may have against ShopGab.com must be resolved by the Delaware Court of Chancery. You hereby submit to the personal jurisdiction of the Delaware Court of Chancery for the purpose of litigating all such claims or disputes.
</p><p>
Termination
This Agreement shall become effective upon your acceptance or your use of the Site, and shall continue until terminated by us or you as provided for under the terms of this Section. Unless otherwise agreed to in writing between the parties, either party may terminate the Agreement at any time upon notice to the other party.
When your membership is terminated, you may no longer have access to data, messages, files and other material you keep on the Site. The material may be deleted along with all your previous posts. You bear all risk of loss of information and data.
</p><p>
General
You agree that the Site shall be deemed solely based in Delaware and that the Site shall be deemed a passive website that does not give rise to personal jurisdiction over us, either specific or general, in jurisdictions other than Delaware. We may amend this Agreement at any time and in our sole discretion by posting the revised terms on this site. Unless otherwise stated in such revision, the revised terms will take effect when they are posted. You are responsible for reviewing the notice and any changes. This Agreement may not be otherwise amended except in a writing signed by both you and us. Your continued use of the Site and our services following changes to the Agreement will constitute your acceptance of changes or modifications to this Agreement. If you do not agree to any changes to this Agreement, do not continue to use the Site or our services.
</p><p>
