...
<div id="addnew-product" class="dialog">
	...
	<div class="addnew-right">
		...
		<a href="javascript:(function(){var e=document.createElement('script');e.src='javascript:(function(){var e=document.createElement('script');e.id='itemnation-script';e.src='http://itemnation.com/bookmark.js?cacheblock=' + Math.floor(Math.random() * 999999999);document.getElementsByTagName('head')[0].appendChild(e)})();"><span>Add To ItemNation</span></a>
                 
		<div class="bookmark-video">
			<iframe width="224" height="114" src="http://www.youtube.com/embed/StC9A8xlJ9E" frameborder="0" allowfullscreen></iframe>
		</div>
	</div>
