		...
		<div>
			<div class="row">
				<div class="span6 add-product-drag">
					...
					<iframe class="add-product-video" width="435" height="275" src="http://www.youtube.com/embed/qDf4w9spx5U?showinfo=0" frameborder="0" allowfullscreen></iframe>
				</div>
			...
			<div class="modal-footer">
				<button class="btn del-add-product-video" data-dismiss="modal" aria-hidden="true">Close</button>
			</div>
		</div>
	</div>