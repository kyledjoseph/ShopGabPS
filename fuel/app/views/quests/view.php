...
<div class="row">
	<div class="col-12 col-sm-8">
		<div class="box marg-top no-border">
			<h4>Products</h4>
			<div class="row">
				<div class="col-12 col-sm-5 col-lg-6 faded">
					Purchase within:
				...
				<div class="col-12 col-sm-7 col-lg-6 faded col-sort-by">
					...
					<?= Form::close() ?>
				<?php endif; ?>
				<button href="#addProductModal" data-toggle="modal" class="btn btn-primary pull-right">Add Product</button>
			</div>
		</div>
		...
		<div class="row product-rows">
			...
			<a href="<?= $product->product_url() ?>" class="quest-product-image-div" style="background-image:url(<?= $product->image_url(250, 220) ?>)">
				<div class="product-name"><?= $product->name() ?> &dash; <span class="faded"><?= $product->price() ?><?php if (isset($user)): ?></span></div>
				<?php if (isset($user) and $quest->belongs_to_user($user->id)): ?>
				<a class="close" href="<?= $quest_product->remove_url() ?>">&times;</a>
			<?php endif; ?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><?= $product->name() ?> <span class="faded"><?= $product->price() ?></span></h4>
        </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					...
					<div class="col-12 col-sm-4 col-lg-3 quest-product-square no<?= ! $quest_product->was_added_by_owner() ? 'from-tab' : null ?>" data-product="<?= $product_i ?>">
						...
						<a style="border-style:dashed; border-size: 2px; background-image:url(/assets/img/add-product.png)" href="#addProductModal" class="quest-product-image-div" data-toggle="modal">
						</a>
					</div>
				</div>
